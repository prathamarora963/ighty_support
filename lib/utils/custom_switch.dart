...
class CustomSwitch extends StatefulWidget {
  ...
  /// activeIcon can be an Icon Widget, an Image or Font awesome Icons.
  ///
  /// This property is optional.
  final Widget? activeIcon;

  /// The icon inside the toggle when the given value is false.
  /// inactiveIcon can be an Icon Widget, an Image or Font awesome Icons.
  ///
  /// This property is optional.
...
class _CustomSwitchState extends State<CustomSwitch>
              ...
              child: Opacity(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: widget.value ? gradient : null,
  ...
  FontWeight get _activeTextFontWeight =>
      widget.activeTextFontWeight ?? FontWeight.w400;

  FontWeight get _inactiveTextFontWeight =>
      widget.inactiveTextFontWeight ?? FontWeight.w400;
